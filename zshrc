...
plugins=(git github hub autojump mvn gradle command-not-found common-aliases cp extract gitignore sudo themes systemadmin vagrant docker rsync python pip grunt docker-compose systemd spring)
