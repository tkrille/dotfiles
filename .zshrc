...
plugins=(git autojump mvn command-not-found common-aliases cp debian extract gitignore sudo themes systemadmin vagrant docker heroku rsync python pip postgres)
